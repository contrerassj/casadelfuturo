...
def Vuelo(InputVuelo):
    ...
    while Aux3<3:
        ...
        if Input3<1 or Input3>100:
            ...
            print("El precio del viaje para",Input3, "personas hacia",Destinos[InputVuelo][0],"es de $",Destinos[InputVuelo][1]*Input3)
            break
        elif Input3>2 and Input3<=6:
            print("El precio del viaje para",Input3, "personas hacia",Destinos[InputVuelo][0],"es de $",Destinos[InputVuelo][1]*0.9,
            ...
            print("El precio del viaje para",Input3, "personas hacia",Destinos[InputVuelo][0],"es de $",Destinos[InputVuelo][1]*0.7,
            ...
            print("El precio del viaje para",Input3, "personas hacia",Destinos[InputVuelo][0],"es de $",Destinos[InputVuelo][1]*0.4,
...
def VueloA(InputVA):
    ...
    while Aux4<3:
        ...
        if Input4<1 or Input4>100:
            ...
            print("El precio del viaje y el alojamiento para",Input4, "personas hacia",Destinos[InputVA][0],"es de $",(Destinos[InputVA][1]+Destinos[InputVA][2])*Input4)
            break
        elif Input4>2 and Input4<=6:
            print("El precio del viaje y el alojamiento para",Input4, "personas hacia",Destinos[InputVA][0],"es de $",(Destinos[InputVA][1]+Destinos[InputVA][2])*0.9,
             "por cada pasaje debido a un 10% de descuento 'Paquete Familia'.")
            print("El precio final es de",(Destinos[InputVA][1]+Destinos[InputVA][2])*0.9*Input4,".")
            break
        elif Input4>6 and Input4<=30:
            print("El precio del viaje y el alojamiento para",Input4, "personas hacia",Destinos[InputVA][0],"es de $",(Destinos[InputVA][1]+Destinos[InputVA][2])*0.7,
             "por cada pasaje debido a un 30% de descuento 'Paquete Excursión'.")
            print("El precio final es de",(Destinos[InputVA][1]+Destinos[InputVA][2])*0.7*Input4,".")
            break
        else:
            print("El precio del viaje y el alojamiento para",Input4, "personas hacia",Destinos[InputVA][0],"es de $",(Destinos[InputVA][1]+Destinos[InputVA][2])*0.4,
             "por cada pasaje debido a un 60% de descuento 'Paquete Cabina'.")
            print("El precio final es de",(Destinos[InputVA][1]+Destinos[InputVA][2])*0.4*Input4,".")
            break
...
def VueloR(InputVR):
    ...
    Aux5=0
    while Aux5<3:
        Input5=int(input("Ingrese la cantidad de pasajes (1 a 100) que desea comprar: "))
        if Input5<1 or Input5>100:
            print("La cantidad de pasajes debe ser, como mínimo, igual a 1, o menor que 101.")
            Aux5+=1
            if Aux5==3:
                print("Límite de intentos alcanzado.")
                break
        elif Input5==1 or Input5==2:
            print("El precio del viaje, el alojamiento y el alquiler del automovil para",Input5, "personas hacia",Destinos[InputVR][0],"es de $",
            (Destinos[InputVR][1]+Destinos[InputVR][2]+Destinos[InputVR][3])*Input5)
            break
        elif Input5>2 and Input5<=6:
            print("El precio del viaje, el alojamiento y el alquiler del automovil para",Input5, "personas hacia",Destinos[InputVR][0],"es de $",
            (Destinos[InputVR][1]+Destinos[InputVR][2]+Destinos[InputVR][3])*0.9,
             "por cada pasaje debido a un 10% de descuento 'Paquete Familia'.")
            print("El precio final es de",(Destinos[InputVR][1]+Destinos[InputVR][2]+Destinos[InputVR][3])*0.9*Input5,".")
            break
        elif Input5>6 and Input5<=30:
            print("El precio del viaje, el alojamiento y el alquiler del automovil para",Input5, "personas hacia",Destinos[InputVR][0],"es de $",
            (Destinos[InputVR][1]+Destinos[InputVR][2]+Destinos[InputVR][3])*0.7,
             "por cada pasaje debido a un 30% de descuento 'Paquete Excursión'.")
            print("El precio final es de",(Destinos[InputVR][1]+Destinos[InputVR][2]+Destinos[InputVR][3])*0.7*Input5,".")
            break
        else:
            print("El precio del viaje, el alojamiento y el alquiler del automovil para",Input5, "personas hacia",Destinos[InputVR][0],"es de $",
            (Destinos[InputVR][1]+Destinos[InputVR][2]+Destinos[InputVR][3])*0.4,
             "por cada pasaje debido a un 60% de descuento 'Paquete Cabina'.")
            print("El precio final es de",(Destinos[InputVR][1]+Destinos[InputVR][2]+Destinos[InputVR][3])*0.4*Input5,".")
            break
